...
app.post("/webhook", async function(req, res) {
  ...
  try {
    ...
    console.log("IA tipo: " + aiData.type);
    if (aiData.error) { console.log("IA error: " + aiData.error.message); }
...
app.get("/", function(req, res) { res.send("ClubIA activo"); });

const PORT = process.env.PORT || 3000;
app.listen(PORT, function() { console.log("ClubIA en puerto " + PORT); });
